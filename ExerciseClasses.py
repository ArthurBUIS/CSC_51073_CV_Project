...
EXERCISES = {
    ...
    "leg extension": ExerciseConfig(name="leg extension", axis=2, opti=-1, landmark_id=29, sensibility=0.35),
    ...
    2.5,  # épaules gauche
    2.5,  # épaules droite
], dtype=np.float32)), #-> ref = video 11, commence en bas
    "bench press": ExerciseConfig(name="bench press", axis=2, opti=-1, landmark_id=15, sensibility=0.4), #-> un peu broken, marche pas hyper bien niveau synchro
    "squat": ExerciseConfig(name="squat", axis=1, opti=1, landmark_id=30, sensibility=0.2),
}